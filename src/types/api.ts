...
export const ERROR_CODES = {
  ...
  DEVICE_SERIAL_CONFLICT: 'DEVICE_SERIAL_CONFLICT',
  DEVICE_STATE_CONFLICT: 'DEVICE_STATE_CONFLICT',
  ENTERPRISE_CODE_CONFLICT: 'ENTERPRISE_CODE_CONFLICT',
  USERNAME_CONFLICT: 'USERNAME_CONFLICT',
  EXCHANGE_STATE_CONFLICT: 'EXCHANGE_STATE_CONFLICT',
  IDEMPOTENCY_KEY_CONFLICT: 'IDEMPOTENCY_KEY_CONFLICT',
  ENTERPRISE_USER_LIMIT: 'ENTERPRISE_USER_LIMIT',
